...
export default function App() {
  ...
  const generatePasswordString = (passwordLenght: number) => {
    ...
    if (upperCase) {
      characgterList += upperCaseChars;
    }
    if (lowerCase) {
      characgterList += lowerCaseChars;
    }
    if (numbers) {
      characgterList += digitChars;
    }
    if (symbols) {
      characgterList += specialChars;
    }

    const passwordResult = createPassword(characgterList, passwordLenght);
